...
ambient_river_boats_init( clientNum )
{
	...
	AssertEx( IsDefined( nearBoat ), "Unable to find entity with targetname: 'cracked_near_boat'" );
	nearBoat thread floatMyBoat( clientNum, false, false );	
	
	//nearCanoe = GetEnt( clientNum, "cracked_near_canoe", "targetname" );
	//AssertEx( IsDefined( nearCanoe ), "Unable to find entity with targetname: 'cracked_near_canoe'" );
	//nearCanoe thread floatMyBoat( clientNum, true, false );
	
	farBoats = GetEntArray( clientNum, "cracked_far_boats", "targetname" );
	AssertEx( IsDefined( farBoats ), "Unable to find entitys with targetnames: 'cracked_far_boats'" );
	AssertEx( farBoats.size != 0, "Unable to find entitys with targetnames: 'cracked_far_boats'" );
