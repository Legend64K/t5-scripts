//
// file: mp_cosmodrome_fx.gsc
// description: clientside fx script for mp_cosmodrome: setup, special fx functions, etc.
...
main()
{
	clientscripts\mp\createfx\mp_cosmodrome_fx::main();
