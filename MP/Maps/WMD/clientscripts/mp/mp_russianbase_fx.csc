//
// file: mp_russianbase_fx.gsc
// description: clientside fx script for mp_russianbase: setup, special fx functions, etc.
...
main()
{
	clientscripts\mp\createfx\mp_russianbase_fx::main();
