//
// file: mp_kowloon_fx.gsc
// description: clientside fx script for mp_kowloon: setup, special fx functions, etc.
...
{
	fxanim_fish = GetEntArray( localClientNum, "fxanim_mp_fish_tank01", "targetname" );
	array_thread( fxanim_fish, ::fxanim_think, localClientNum );
}
...
fxanim_think( localClientNum )
{
	...
	self SetAnim( level.kowloon_fxanims[ "mp_fish_tank01_anim" ], 1.0, 0.0, 1.0 );
}

main()
{
	clientscripts\mp\createfx\mp_kowloon_fx::main();
