...
ape_think()
{
	...
	self thread ape_KillOnProximity();
...
//this is a completely seperate APE taunt mechanic
//that appears between rounds.  
#using_animtree( "generic_human" );
ape_taunt_deleter()
{
...
ape_taunt_go(destination, player, boss_battle)
{
		...
		{
			//You killed my brother, but you will not Kill me! HAHAHA
		}
...
ape_taunt_player()
{
	...
	while(1)
	{
		...
		else
		{
		 ...
		 //maps\_zombietron_challenges::is_this_a_challenge_round(level.round_number))
