...
// make sure the thundergun in included in the level
thundergun_exists()
{
	if(GetDvarInt(#"zombiemode") == 0)
	{
		return true;	 // if this is being called outside of zombie mode - assume that the caller know's what they are doing, and don't let the next line assert.
	}
