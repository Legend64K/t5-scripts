...
precache_scripted_fx()
{
	...
	//level._effect["lander_yellow"] 								= loadfx("maps/zombie/fx_zmb_csm_lander_post_yellow");
	...
	level._effect["panel_green"] = LoadFX("maps/zombie/fx_zmb_csm_lander_panel_green");//.efx
	...
	// Effect for Light Spin in Gantry level
...
precache_createfx_fx()
{
	...
	// Exploders
	level._effect["fx_zmb_pad_light"]									= loadfx("maps/zombie/fx_zmb_csm_rocket_pad_light");	// 5501, 5502, 5503
	level._effect["fx_zmb_gantry_coolant_md"]					= loadfx("maps/zombie/fx_zmb_gantry_coolant_md");	// 5601
	level._effect["fx_elec_terminal"]									= loadfx("maps/zombie/fx_zmb_elec_terminal_arc");	// 5401
	level._effect["fx_zmb_elec_terminal_bridge"]			= loadfx("maps/zombie/fx_zmb_elec_terminal_bridge");	// 5401
	level._effect["fx_zmb_russian_rocket_smk"] 				= loadfx("maps/zombie/fx_zmb_russian_rocket_smk");	// needs number!
...
/*------------------------------------
listens for the state changes on the docking station
------------------------------------*/
...
/*------------------------------------
toggles the colored lighs around the lander docking stations
------------------------------------*/
toggle_lander_lights(color)
{
	...
	for(x = 0;x<players.size;x++)
	{
		...
		//go through the doors and determine the correct FX to play on them based on the model
